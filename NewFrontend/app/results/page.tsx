...
import { ArrowLeft, Download, Lock, Share2, Unlock } from "lucide-react"
...
export default function ResultsPage() {
  ...
  const handleDownload = () => {
    ...
    a.href = url
    a.download = `encrypted-message-${new Date().toISOString().slice(0, 10)}.json`
          ...
          {result ? (
            <Card className="max-w-4xl mx-auto">
              <CardHeader>
                ...
                <CardDescription>
                  Your message has been successfully encrypted using hybrid cryptography. Encrypted on{" "}
                  {result.timestamp}
                </CardDescription>
              </CardHeader>
              <CardContent>
                  ...
                  <TabsContent value="message" className="space-y-4 pt-4">
                    <div className="relative">
                      ...
                      <Button
                        ...
                        onClick={() => handleCopyToClipboard(result.encryptedMessage, "Encrypted message")}
                      >
                  ...
                  <TabsContent value="key" className="space-y-4 pt-4">
                    <div className="relative">
                      ...
                      <Button
                        ...
                        size="icon"
                        className="absolute top-2 right-2"
                        onClick={() => handleCopyToClipboard(result.encryptedKey, "Encrypted key")}
                      >
                        <Share2 className="h-4 w-4" />
                        <span className="sr-only">Copy to clipboard</span>
                      </Button>
              ...
              <CardFooter className="flex justify-between">
                <div className="flex gap-2">
                  <Button variant="outline" onClick={() => router.push("/encrypt")}>
                    Encrypt Another Message
                  </Button>
                  <Button variant="outline" onClick={() => router.push("/decrypt")}>
