...
export default function EncryptPage() {
  ...
  const handleEncrypt = async () => {
    ...
    try {
      ...
      // For now, we'll simulate encryption with a timeout
  ...
  const generateRandomHillKey = () => {
    ...
    do {
      ...
      determinant = a * d - b * c
    } while (determinant === 0 || determinant % 2 === 0 || determinant % 13 === 0)
        ...
        <div className="container px-4 md:px-6">
          ...
          <Card className="max-w-4xl mx-auto">
            <CardHeader>
              ...
              <CardDescription>
                Enter your message and encryption parameters to secure your data using Hill Cipher and RSA encryption.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <Tabs defaultValue="message" className="w-full">
                          ...
                          <Tooltip>
                            ...
                            <TooltipContent>
                              <p className="max-w-xs">
                                Enter a 2x2 matrix with values separated by spaces and rows on new lines. The matrix
                                must have a determinant that is coprime with 26.
                              </p>
                            </TooltipContent>
                          </Tooltip>
                        </TooltipProvider>
                      </Label>
                      <Button variant="outline" size="sm" onClick={generateRandomHillKey}>
                        Generate Random Key
                      </Button>
                    </div>
                    <Textarea
                ...
                <TabsContent value="rsa" className="space-y-4 pt-4">
                  <div className="space-y-4">
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="rsa-private">RSA Private Key (Optional - only needed for decryption)</Label>
                      <Textarea
                        id="rsa-private"
